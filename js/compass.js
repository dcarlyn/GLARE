    ...
    window.Compass = function(canvasElement, headingElement) {
        ...
        try {
            ...
            if(!this.gl) {
              ...
              this.gl.viewportWidth = 100;
              this.gl.viewportHeight = 100;
        ...
        init: function() {
            ...
            window.addEventListener('orientationchange', function() {
              ...
              window.setTimeout(function() {
                ...
                self.gl.viewportWidth = self.canvasElement.width = 100;
                self.gl.viewportHeight = self.canvasElement.height = 100;
